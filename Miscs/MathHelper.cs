...
public static class MathHelper
{
    ...
    public static int FloorToInt(double num)
    {
    ...
    public static Avalonia.Vector Clamp(Avalonia.Vector vec, Avalonia.Vector min, Avalonia.Vector max)
    {
        return new Avalonia.Vector(Clamp(vec.X, min.X, max.X), Clamp(vec.Y, min.Y, max.Y));
    }
    ...
    public static Avalonia.Vector Lerp(Avalonia.Vector a, Avalonia.Vector b, double t)
    {
        return new Avalonia.Vector(Lerp(a.X, b.X, t), Lerp(a.Y, b.Y, t));
    }
    ...
    public static Avalonia.Vector CubicLerp(Avalonia.Vector a, Avalonia.Vector b, Avalonia.Vector c, Avalonia.Vector d, double t)
    {
        return new Avalonia.Vector(CubicLerp(a.X, b.X, c.X, d.X, t), CubicLerp(a.Y, b.Y, c.Y, d.Y, t));
    }
    ...
    public static Avalonia.Vector Hermite(Avalonia.Vector t)
    {
        return new Avalonia.Vector(Hermite(t.X), Hermite(t.Y));
    }
    ...
    public static Avalonia.Vector Quintic(Avalonia.Vector t)
    {
        return new Avalonia.Vector(Quintic(t.X), Quintic(t.Y));
    }
