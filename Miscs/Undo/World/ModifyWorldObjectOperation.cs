...
public class ModifyWorldObjectOperation : FrameBasedOperation
{
    public ModifyWorldObjectOperation(WorldObject obj, PropertyChangeInfo change)
    {
        _modifyObject = obj;
        _change = change;
    }
    ...
    public override void Redo()
    {
        ...
        WorkspaceViewModel.Current.Workspace.UnwatchWorldObjectPropertyChange(_modifyObject);
        propInfo.SetValue(_modifyObject, obj);
        WorkspaceViewModel.Current.Workspace.WatchWorldObjectPropertyChange(_modifyObject);
    ...
    {
        if (other is ModifyWorldObjectOperation modifying && _modifyObject == modifying._modifyObject && _change.PropertyName == modifying._change.PropertyName)
        {
