...
public class ModifyLevelObjectOperation : FrameBasedOperation
{
    public ModifyLevelObjectOperation(LevelObject obj, PropertyChangeInfo change)
    {
        _modifyObject = obj;
        _change = change;
    }
    ...
    public override void Redo()
    {
        ...
        WorkspaceViewModel.Current.Workspace.UnwatchLevelObjectPropertyChange(_modifyObject);
        propInfo.SetValue(_modifyObject, obj);
        WorkspaceViewModel.Current.Workspace.WatchLevelObjectPropertyChange(_modifyObject);
    ...
    {
        if (other is ModifyLevelObjectOperation modifying && _modifyObject == modifying._modifyObject && _change.PropertyName == modifying._change.PropertyName)
        {
