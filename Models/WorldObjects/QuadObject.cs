...
public class QuadObject : WorldObject
{
    public QuadObject()
    {
    }
    ...
    public override void OnReadyAdding(World world)
    {
        _addingSelection = ObjectPool<Selection>.Get(this);
        _addingSelection.VertexColor = new Vector4(1.0f, 1.0f, 0.0f, 1.0f);
        world.AddObject(_addingSelection, false);
        world.AddObject(this, false);
    }

    public override void OnCancelAdding(World world)
    {
        world.RemoveObject(_addingSelection);
        world.RemoveObject(this);
        ObjectPool<Selection>.Return(_addingSelection);
    }

    public override void OnPlaceFromAdding(World world)
    {
        world.RemoveObject(_addingSelection);
        ObjectPool<Selection>.Return(_addingSelection);
    }
