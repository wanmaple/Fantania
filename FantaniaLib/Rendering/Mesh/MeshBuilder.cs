...
public static class MeshBuilder
{
    ...
    public static Mesh CreateStandardQuad(Vector2 size)
    {
        VertexStandard[] quadVerts = [
            new VertexStandard { Position = new Vector3(0.0f, 0.0f, 0.0f), UV = Vector2.Zero, Color = Vector4.One, },
            new VertexStandard { Position = new Vector3(size.X, 0.0f, 0.0f), UV = Vector2.UnitX, Color = Vector4.One, },
            new VertexStandard { Position = new Vector3(size.X, size.Y, 0.0f), UV = Vector2.One, Color = Vector4.One, },
            new VertexStandard { Position = new Vector3(0.0f, size.Y, 0.0f), UV = Vector2.UnitY, Color = Vector4.One, },
        ];
        ushort[] quadIndices = [0, 1, 2, 0, 2, 3];
        return Mesh.From(quadVerts, quadIndices);
    }
