...
public class PerlinNoise2DParameters : NoiseParameters
{
    ...
    public NoiseHelper.PerlinSmoothFunctions SmoothFunction
    {
        ...
        set
        {
            if (_smoothFunc != value)
            {
                _smoothFunc = value;
                OnPropertyChanged(nameof(SmoothFunction));
            }
        }
    }
}
...
public class PerlinNoise2D : INoise2D
{
    ...
    public PerlinNoise2DParameters Arguments { get; private set; }

    public PerlinNoise2D(PerlinNoise2DParameters args)
    {
        Arguments = args;
    }
