...
public class ForegroundsRenderer : IRenderer
{
    ...
    public ForegroundsRenderer(Stylegrounds sgs)
    {
        _stylegrounds = sgs;
    }
    ...
    {
        _stylegrounds.ForegroundAdded -= OnForegroundAdded;
        _stylegrounds.ForegroundRemoved -= OnForegroundRemoved;
    ...
    {
        foreach (var sg in _stylegrounds.Foregrounds)
        {
            OnForegroundAdded(_stylegrounds, sg, null);
        }
        _stylegrounds.ForegroundAdded += OnForegroundAdded;
        _stylegrounds.ForegroundRemoved += OnForegroundRemoved;
    }
    ...
    void OnForegroundAdded(Stylegrounds sgs, Styleground sg, Styleground prev)
    {
    ...
    void OnForegroundRemoved(Stylegrounds sgs, Styleground sg, Styleground prev)
    {
        IRenderer renderer = _sgRenderers[sg];
